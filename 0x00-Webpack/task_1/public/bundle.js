...
(() => {
      ...
      692: function (e, t) {
        ...
        !(function (t, n) {
            ...
            function ge(e, t, n, r, o, i) {
              return (
                ...
                te(function (i, a, s, u) {
                  ...
                  } else (d = he(d === a ? d.splice(y, d.length) : d)), o ? o(null, a, d, u) : g.apply(a, d);
                })
              );
            }
            function ve(e) {
              ...
              function (e, t) {
                k.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (X[e] || k.uniqueSort(o), z.test(e) && o.reverse()),
                    this.pushStack(o)
                  );
                };
              }
                ...
                var t = [
                  ...
                  o = {
                    ...
                    then: function (e, n, o) {
                      ...
                      return k
                        .Deferred(function (r) {
                          t[0][3].add(a(0, r, y(o) ? o : G, r.notifyWith)),
          ...
          function Ue(e, t, n, r) {
            ...
            if (
              p &&
              ((i = (o = Le(t, e[0].ownerDocument, !1, e, r)).firstChild),
              1 === o.childNodes.length && (o = i),
              i || r)
            ) {
              for (s = (a = k.map(De(o, 'script'), Be)).length; f < p; f++)
                (l = o),
                  f !== d &&
                    ((l = k.clone(l, !0, !0)),
                ...
                d.hasContent
                  ...
                  : ((p = d.url.slice(o.length)),
                    d.data &&
                      ...
                      ((o += (qt.test(o) ? '&' : '?') + d.data), delete d.data),
                    !1 === d.cache &&
                      ((o = o.replace($t, '$1')),
                      (p = (qt.test(o) ? '&' : '?') + '_=' + Nt.guid++ + p)),
                    (d.url = o + p)),
                d.ifModified &&
                  (k.lastModified[o] &&
          ...
          k.ajaxSetup({
            ...
            k.each(['top', 'left'], function (e, t) {
              k.cssHooks[t] = et(v.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = Ze(e, t)), Ge.test(n) ? k(e).position()[t] + 'px' : n
                  );
              });
            }),
  ...
  (n.n = (e) => {
    ...
    (() => {
      ...
      const r = _.debounce(function () {
        const e = t()('#count').html() || 0;
        t()('#count').html(parseInt(e) + 1 + ' clicks on the button');
      }, 500);
      t()('button').on('click', r);
    })();
})();
